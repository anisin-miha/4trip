...
class I18nGenPagesPlugin {
  constructor(options = {}) {
    ...
    this.excursionsLimit =
      options.excursionsLimit || process.env.I18N_EXCURSIONS_LIMIT || "";
  ...
  apply(compiler) {
    const trigger = async () => {
      ...
      try {
        ...
        if (this.excursionsLimit)
          process.env.I18N_EXCURSIONS_LIMIT = String(this.excursionsLimit);
