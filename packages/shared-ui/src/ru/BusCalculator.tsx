      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-2">
          <button
            type="button"
            onClick={() => setBus("mini")}
            className={`px-3 py-2 border rounded-md ${bus === "mini" ? "bg-black text-white" : "bg-white"}`}
          >
            Микро (18–20)
          </button>
          <button
            type="button"
            onClick={() => setBus("mid")}
            className={`px-3 py-2 border rounded-md ${bus === "mid" ? "bg-black text-white" : "bg-white"}`}
          >
            Средний (30–35)
          </button>
          <button
            type="button"
            onClick={() => setBus("big")}
            className={`px-3 py-2 border rounded-md ${bus === "big" ? "bg-black text-white" : "bg-white"}`}
          >
            Большой (45–50)
          </button>
        </div>
