...
export const patriotTour = {
  ...
  meetingPoint: {
    ...
    info: [
      ...
      { label: "Время начала", value: "08:45" },
      { label: "Длительность", value: "около 9 ч." },
      {
        label: "Место встречи",
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "В стоимость включены проезд на комфортабельном автобусе, входные билеты во все объекты парка и экскурсионное сопровождение.",
    },
    {
