...
export const sergievPosadTour = {
  ...
  exclusions: ["Входные билеты в некоторые музеи/экспозиции по желанию"],
  routeVariants: [
    {
      id: "lavra",
      title: "Лавра и центр",
      points: ["Троице-Сергиева лавра", "Музей фарфора", "Исторический центр"],
      description: ["Прогулка по Лавре с посещением ключевых храмов и музея фарфора."],
    },
  ],
  longread: {
    title: "О Сергиевом Посаде",
    tldr: ["Лавра", "История и ремёсла", "Музеи"],
    paragraphs: [
      "Сергиев Посад — один из духовных центров России. Маршрут включает осмотр архитектурных ансамблей Лавры и посещение музея фарфора.",
      "Гид расскажет о влиянии Сергия Радонежского и особенностях русской культовой архитектуры.",
    ],
  },
  details: [
