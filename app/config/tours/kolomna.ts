...
export const kolomnaTour = {
  ...
  inclusions: ["Транспорт", "Сопровождение гида"],
  exclusions: ["Дегустации и мастер-классы по желанию"],
  routeVariants: [
    {
      id: "classic",
  ...
  longread: {
    ...
    paragraphs: [
      "Коломна — сочетание древней архитектуры, ремесленных традиций и гастрономических особенностей региона. В туре мы посетим кремль, музей пастилы и узнаем историю калача.",
    ],
  },
  details: [
