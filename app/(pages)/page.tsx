      ...
      <main className="py-16">
        <section className="container mx-auto px-4 mb-16 mt-24 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Организуем комфортные групповые туры в Парк «Патриот», Сергиев Посад
            и другие интересные места.
          </p>
          <p className="max-w-2xl mx-auto text-gray-700">
            Мы предлагаем увлекательные маршруты с опытными гидами. Наш
            транспорт обеспечит удобство в пути, а насыщенные программы сделают
            ваши поездки запоминающимися!
          </p>
        </section>
